...
public ref struct ImageData
{
    ...
    {
        int size = EstimateStride(imageSize.Width, pixelFormat) * imageSize.Height;
        if (data.Length < size)
        {
    ...
    public static ImageData CreatePooled(Size imageSize, ImagePixelFormat pixelFormat)
    {
        ...
        IMemoryOwner<byte> memory = pool.Rent(size);
    ...
    public static ImageData FromArray(byte[] pixels, ImagePixelFormat pixelFormat, Size imageSize)
        => new(new Span<byte>(pixels), pixelFormat, imageSize);
    ...
    /// <param name="imageSize">The image dimensions.</param>
    /// <returns>A new <see cref="ImageData"/> instance.</returns>
    public static ImageData FromPointer(nint pointer, ImagePixelFormat pixelFormat, Size imageSize)
    {
        Span<byte> span = CreateSpan(pointer, imageSize, pixelFormat);
    ...
    /// <param name="height">The image height.</param>
    /// <returns>A new <see cref="ImageData"/> instance.</returns>
    public static ImageData FromPointer(nint pointer, ImagePixelFormat pixelFormat, int width, int height)
    ...
    private static unsafe Span<byte> CreateSpan(nint pointer, Size imageSize, ImagePixelFormat pixelFormat)
    {
        int size = EstimateStride(imageSize.Width, pixelFormat) * imageSize.Height;
