...
public unsafe class AudioStream : MediaStream
{
    ...
    internal AudioStream(Decoder stream, MediaOptions options)
        : base(stream, options)
    {
        AVChannelLayout layout = Info.ChannelLayout;
        SwrContext* context;
    ...
    {
        AudioFrame frame = base.GetNextFrame() as AudioFrame;

        AudioFrame converted = AudioFrame.Create(
                                                 frame.SampleRate,
                                                 frame.NumChannels,
                                                 frame.NumSamples,
                                                 frame.ChannelLayout,
    ...
    {
        AudioFrame frame = base.GetFrame(time) as AudioFrame;
