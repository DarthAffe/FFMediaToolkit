...
public class MediaOptions
{
    ...
    /// </summary>
    public ContainerOptions DemuxerOptions { get; set; } = new();
    ...
    {
        get => int.TryParse(DecoderOptions[THREADS], out int count) ? (int?)count : null;
    ...
    /// </summary>
    public Dictionary<string, string> DecoderOptions { get; set; } = new();
    ...
    {
        MediaMode mode = (MediaMode)(1 << (int)type);
