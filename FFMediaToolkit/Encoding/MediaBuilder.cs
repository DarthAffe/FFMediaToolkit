...
public class MediaBuilder
{
    ...
    public static MediaBuilder CreateContainer(string path, ContainerFormat format) => new(path, format);
    ...
    /// <param name="path">A path to create the output file.</param>
    /// <returns>The <see cref="MediaBuilder"/> instance.</returns>
    public static MediaBuilder CreateContainer(string path) => new(path, null);
